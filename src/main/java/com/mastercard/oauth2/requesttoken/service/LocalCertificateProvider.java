...
public class LocalCertificateProvider {
    ...
    private static final Logger log = LoggerFactory.getLogger(LocalCertificateProvider.class);
    ...
    private SignerPublicKey getSignerPublicKey(String algorithm, String alias, KeyStore keyStore) {
        try {
            java.security.cert.Certificate preferredCertificate = keyStore.getCertificate(alias);
